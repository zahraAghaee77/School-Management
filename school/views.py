...
class AddStudentToClassView(APIView):
    ...
    def post(self, request, class_id):
        try:
            ...
            return Response(
                {
                    "error": "The class was not found or you do not have permission to modify this."
                },
                status=status.HTTP_404_NOT_FOUND,
            )

        serializer = AddRemoveStudentClassSerializer(data=request.data)
        if serializer.is_valid():
...
class DeleteStudentFromClassAPI(APIView):
...
class TeacherListStudentsInClass(APIView):
    permission_classes = [IsTeacher]
    ...
    def get(self, request, class_id):
        try:
            ...
            return Response(
                {
                    "error": "The class was not found or you do not have permission to access this."
                },
                status=status.HTTP_404_NOT_FOUND,
            )
...
class ManagerListStudentsInClass(APIView):
    ...
    def get(self, request, class_id):
        ...
        except Class.DoesNotExist or School.DoesNotExist:
            return Response(
                {
                    "error": "The class was not found or you do not have permission to access this."
                },
...
class StudentClassAPI(APIView):
    ...
    def get(self, request):
        ...
        all_classes = student.class_students.all()
        serializer = StudentClassSerializer(all_classes, many=True)
        return Response(serializer.data, status=status.HTTP_200_OK)

    def get(self, request, class_id):
        student = request.user
        try:
            cls = student.class_students.get(id=class_id)
        except Class.DoesNotExist:
            return Response(
                {
                    "error": "The class was not found or you do not have permission to access this."
        ...
        serializer = StudentClassSerializer(cls)
        return Response(serializer.data, status=status.HTTP_200_OK)
...
class CreateSchoolAPI(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                {"message": "School was created successfully", "data": serializer.data},
                status=status.HTTP_201_CREATED,
            )
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def patch(self, request, pk):
        try:
            ...
            return Response(
                {"error": "The school was not found."},
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                {"message": "school was updated successfully", "data": serializer.data},
                status=status.HTTP_200_OK,
            )
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
